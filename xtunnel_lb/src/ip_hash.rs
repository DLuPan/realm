...
mod tests {
    ...
    fn ih_any_hash() {
        ...
        run!(b"xtunnel", 885396906);
        run!(b"1 xtunnel", 4115282535);
        run!(b"2 xtunnel", 1326782105);
        run!(b"3 xtunnel", 1796078392);
        run!(b"10 xtunnel", 2265248424);
        run!(b"100 xtunnel", 4289654351);
    }
